...
namespace BackgroundWorker.Migrations
{
    ...
    [Migration("20240926094354_FixSensorIdLength")]
    partial class FixSensorIdLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoApp.Core.Db.Models.Sensor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DemoApp.Core.Db.Models.WiredSensor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DemoApp.Core.Db.Models.Sensor", b =>
                {
                    b.HasOne("DemoApp.Core.Db.Models.Device", null)
                        .WithMany("Sensors")
